...
1. Clone the repository `git clone https://github.com/ans-cloud/public-ip-management-automation-azure.git`
...
az deployment group create \
  --name "deploy-public-ip-management-automation-azure" \
